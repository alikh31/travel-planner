...
import { MapPin, Car, Bus, PersonStanding, Navigation, Bike, ChevronDown, ChevronUp } from 'lucide-react'
...
export default function Commute({ 
  ...
  return (
    <div className={`flex justify-center my-4 ${className}`}>
      <div className="w-full max-w-md bg-blue-50 border border-blue-200 rounded-lg p-3">
        {/* Route Info */}
